...
def main():
	...
	pygame.display.set_caption('Zadanie - piłka i grawitacja!')
	...
	while True:
        ...
        # tu wpisać zmianę składowej prędkości jeśli ballrect.left lub right
        # oraz top lub bottom przekraczają odpowiednie granice
